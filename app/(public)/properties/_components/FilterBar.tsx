...
{/* Availability */} <Select value={availability} onValueChange={setAvailability}> <SelectTrigger className="w-42.5"> <SelectValue placeholder="Availability" /> </SelectTrigger>
...
```
  ...
  <Select value={location} onValueChange={setLocation}>
    ...
    <SelectContent>
      ...
      <SelectItem value="Cox's Bazar">Coxs Bazar</SelectItem>
    </SelectContent>
  </Select>
  ...
  <Select value={category} onValueChange={setCategory}>
    ...
    <SelectContent>
      ...
      <SelectItem value="Modern Apartment">
        Modern Apartment
      </SelectItem>
